    ...
    <main className="standard-page-format">
      <section className={classes.legalSection}>
        <h2
          ...
          data-testid="header-terms-conditions-page"
        >
          TERMS & CONDITIONS
        </h2>
        <p className={classes.legalParagraph}>
          By visiting and using becomingmatthew.com (hereinafter the “Website”),{' '}
          <strong>
            you accept and agree to be bound by these Terms and Conditions
            including our Disclaimer and Privacy Policy posted on the website
        ...
        <p className={classes.legalParagraph}>
          ...
          website. Becoming Matthew (“company”, “I”, “we” or “us”) reserves the
        ...
        <strong>
          ...
          updates. You must not access or use the website if you do not wish to
      ...
      <section className={classes.legalSection}>
        ...
        <p className={classes.legalParagraph}>
          ...
          individuals over the age of 18. Children, as defined in our Privacy
      ...
      <section className={classes.legalSection}>
        ...
        <p className={classes.legalParagraph}>
          Your acceptance of our Disclaimer is expressly incorporated into these
          Terms and Conditions. Please review the Disclaimer for more
          information.
        </p>
      </section>
      <section className={classes.legalSection}>
        ...
        <p className={classes.legalParagraph}>
          ...
          arising from or related to the website and our products/services. In
          the event of a dispute, claim, or controversy arising from or relating
          to your use of this website, the terms and conditions shall be
          construed under the laws of the state of New Zealand.
        </p>

        <p className={classes.legalParagraph}>
          You agree to first resolve any disputes or claims through mandatory
          arbitration, and you consent to and submit to the jurisdiction and
          courts of New Zealand, without regard to conflict of law principles or
          where the parties are located at the time of the dispute.
        </p>

        <p className={classes.legalParagraph}>
          You agree to bear the full cost of arbitration, to the extent
          permitted by law. Participation in arbitration in good faith is a
          condition precedent to pursuing any other legal or equitable remedies
          available, such as litigation or any other legal procedure. You also
          agree that if a legal claim is filed after the required arbitration,
      ...
      <section className={classes.legalSection}>
        ...
        <p className={classes.legalParagraph}>
          ...
          non-commercial, non-transferrable, informational, and educational use
          only while ensuring it’s not in violation of any copyright, trademark,
          and intellectual property or proprietary rights.
        </p>
        ...
        <p className={classes.legalParagraph}>
          ...
          reverse engineer, sell, rent, or license any part of the Content in
          any way to anyone, without our prior written consent. You agree to
          abide by the copyright, trademark laws, and intellectual property
          rights and shall be solely responsible for any violations of these
      ...
      <section className={classes.legalSection}>
        ...
        <p className={classes.legalParagraph}>
          ...
          transmit, send, email, or submit to us on the website or any of our
        ...
        <p className={classes.legalParagraph}>
          ...
          edit, reproduce any Content provided by you on our website and any of
          our social media sites for any purpose. You shall be solely liable for
          any damages resulting from any infringement of copyrights, trademarks,
          or other proprietary rights of any Content or information that you
          provide to us.
        </p>
        ...
        <p className={classes.legalParagraph}>
          ...
          viruses, any kind of malicious computer software, or any other harmful
      ...
      <section className={classes.legalSection}>
        ...
        <p className={classes.legalParagraph}>
          ...
          You assume all risks for using these third-party websites or resources
          and any transactions between you and these third-party websites are
          strictly between you and the third party. We shall not be liable for
          any damages resulting from your use of these third-party websites or
          resources.
        </p>
      </section>
      <section className={classes.legalSection}>
        ...
        <p className={classes.legalParagraph}>
          On this website, we may provide free products for download as well as
          sell paid courses, programs, physical or digital products, and any
          other related materials (collectively, “products”). All of our
          products and/or services, including all content, are copyright
          protected under US and international copyright laws. You are granted a
        ...
        <p className={classes.legalParagraph}>
          ...
          engineer, enhance, or exploit our products. You cannot sell or
          redistribute any of our products, whether free or paid, without our
          express written consent. You agree to abide by the copyright,
      ...
      <section className={classes.legalSection}>
        ...
        <p className={classes.legalParagraph}>
          ...
          access by a third party of your information from the website
        ...
        <p className={classes.legalParagraph}>
          ...
          from negligence, breach of contract, tort, or any other legal theory
          of liability. You agree that we provide no express or implied
      ...
      <section className={classes.legalSection}>
        ...
        <p className={classes.legalParagraph}>
          ...
          Policy and Disclaimer and any notice given in electronic form shall be
      ...
      <section className={classes.legalSection}>
        ...
        <p className={classes.legalParagraph}>
          ...
          to (a) revise these Terms and Conditions; (b) modify the website
          and/or any services or products it offers; and (c) discontinue the
          website and/or products or services at any time. Any changes to these
          terms will take effect immediately. You agree to review these Terms
          and Conditions and any other online policies posted on the website
          regularly to be aware of any changes. You agree to be bound by the
          revision if you continue to use or access the website after these
          modifications.
        </p>
      </section>
      <section className={classes.legalSection}>
        ...
        <p className={classes.legalParagraph}>
          By using any of our products, or services or accessing the site, you
          acknowledge that you have read and agree to be bound by these terms
          and conditions.
        </p>
      </section>
      <section className={classes.legalSection}>
